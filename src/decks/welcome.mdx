...
By the way – notice how when you navigate from page to page, the URL changes. Even though your web app is being served in a *frame*, its routes are exposed in the window's *location hash*, allowing for easy sharing. 
...
Since each FeaturePeek project gets its own subdomain, your cookies and local storage will persist from one environment to another. 
